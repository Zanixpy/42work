...
/*   Updated: 2025/12/15 21:53:20 by omawele          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void load_coins_textures(t_var *var)
{
	...
	var->t.coins.c1 = mlx_xpm_file_to_image(var->mlx.init, "./textures/coins/c1.xpm",
			&width, &height);
    var->t.coins.c2 = mlx_xpm_file_to_image(var->mlx.init, "./textures/coins/c2.xpm",
			&width, &height);
    var->t.coins.c3 = mlx_xpm_file_to_image(var->mlx.init, "./textures/coins/c3.xpm",
			&width, &height);
    var->t.coins.c4 = mlx_xpm_file_to_image(var->mlx.init, "./textures/coins/c4.xpm",
			&width, &height);
    var->t.coins.c5 = mlx_xpm_file_to_image(var->mlx.init, "./textures/coins/c5.xpm",
			&width, &height);
    var->t.coins.c6 = mlx_xpm_file_to_image(var->mlx.init, "./textures/coins/c6.xpm",
			&width, &height);
    var->t.coins.c7 = mlx_xpm_file_to_image(var->mlx.init, "./textures/coins/c7.xpm",
			&width, &height);
    var->t.coins.c8 = mlx_xpm_file_to_image(var->mlx.init, "./textures/coins/c8.xpm",
			&width, &height);
}
